...
def _main():
    ...
    pred_lp, pred_dc, categorical_true_lp, true_dc = utils.compute_predictions_and_gt(model, test_generator,
    ...
    utils.plot_confusion_matrix(true_dc, pred_bin_domains, DOM_CLASSES, FLAGS.experiment_rootdir, normalize=True,
    ...
    utils.plot_pr_curve(source_pred_cat_labels, source_true_cat_labels, FLAGS.experiment_rootdir, LAB_CLASSES,
    ...
    utils.plot_pr_curve(target_pred_cat_labels, target_true_cat_labels, FLAGS.experiment_rootdir, LAB_CLASSES,
